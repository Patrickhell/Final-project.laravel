    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate(
            ...
            [
                ...
                'cv_file.mimes' => 'I file deve essere un pdf', // Da fixare
                'cv_file.max' => 'I file deve essere di dimensione max: 3kb', // Da fixare
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate(
            [
                ...
                'performance' => 'required|string|max:255|min:5',
                'profile_picture' => 'required|',
                'cv_file' => 'required|mimes:pdf|max:5048',
                'specialties' => ['required', 'array', 'min:1'],
                'specialties.*' => ['exists:specialties,id'],
            ],
            [
                ...
                'profile_picture.required' => 'Inserisci un\'imagine di profilo',
                'cv_file.required' => 'I file deve essere un pdf',
                'cv_file.max' => 'I file deve essere di dimensione max: 3kb',
                'specialties' => 'Scegli una o più specialità',
            ]
