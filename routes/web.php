...
Route::middleware(['auth', 'check.profile'])->prefix('dashboard')->name('user.')->group(function () {
    ...
    Route::get('/payment/token', [CheckoutController::class, 'generate'])->name('generate');
    Route::get('/make/payment/{sponsorship}', [CheckoutController::class, 'makePayment'])->name('makePayment');
