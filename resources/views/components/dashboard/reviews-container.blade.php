<section class="bd_dashboard-rvws-section mt-8">
    <div class="flex justify-between w-full items-center mb-3">
        <h2 class="text-md sm:text-xl font-bold">Recensioni Recenti</h2>
        <a href="{{ route('user.reviews') }}" class="text-white focus:ring-4 focus:outline-none focus:ring-bd_btn-shadow font-medium rounded-lg shadow-md text-sm px-4 py-2 text-center bd_btn">
            Visualizza di piu
        </a>
    </div>

    {{-- From mobile to md --}}
    <div class="w-full p-4 bg-white rounded-xl shadow-md md:hidden">
    ...
    {{-- From md to full --}}
    <div class="w-full rounded-xl bg-white shadow-md overflow-hidden hidden md:block">
