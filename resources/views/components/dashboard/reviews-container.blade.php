<section class="bd_dashboard-rvws-section">
    <div class="flex justify-between w-full items-center mb-3">
        ...
        <a href="{{ route('user.reviews') }}" class="text-white focus:ring-4 focus:outline-none focus:ring-bd_btn-shadow font-medium rounded-full text-sm px-4 py-2 text-center mr-3 md:mr-0 bd_btn">
            Visualizza di piu
        </a>
    </div>
