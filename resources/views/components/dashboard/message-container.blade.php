<section class="bd_dashboard-msg-section mt-8">
    <div class="flex justify-between w-full items-center mb-3">
        <h2 class="text-md sm:text-xl font-bold">Messaggi recenti</h2>
        <a href="{{ route('user.messages') }}" class="text-white focus:ring-4 focus:outline-none focus:ring-bd_btn-shadow font-medium rounded-full text-sm px-4 py-2 text-center bd_btn">
            Visualizza di piu
        </a>
    </div>
