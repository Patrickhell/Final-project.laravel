...
<x-app-layout>
    <div class="bd_dashboard-wrapper">
        ...
        <div class="bd_dashboard-stats-wrapper w-full">
            <x-dashboard.stats-cards :reviews="$reviews" :averageVote="$averageVote" :messages="$messages" :totalMessagesCount="$totalMessagesCount" :totalReviewsCount="$totalReviewsCount"/>
        </div>
        {{-- Message Container --}}
