...
<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between md:mb-4">
    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between md:mt-4">
        <div>
            <p class="text-sm flex gap-1 text-gray-700 leading-5">
                {!! __('Mostra') !!}
