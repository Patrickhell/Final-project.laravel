<nav id="mobilebar" class="fixed z-20 bottom-5 left-5 right-5 h-24 transition-transform translate-y-0 xl:-translate-y-[-150%]" role="navigation">
        ...
        <section class="ml-10">
            <ul>
                <li class="flex flex-col items-center">
                    ...
                    <!-- Dropdown menu -->
                    <div id="userMenuMobileDropdown" class="z-10 hidden lg:hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-56 dark:bg-gray-700 dark:divide-gray-600">
