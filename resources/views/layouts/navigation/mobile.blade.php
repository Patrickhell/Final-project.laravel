<nav id="mobilebar" class="fixed bottom-5 left-5 right-5 h-24 transition-transform translate-y-0 md:-translate-y-[-150%]" role="navigation">
    <div class="h-full px-3 py-4 overflow-y-hidden flex flex-row items-center justify-between dark:bg-gray-800">
        <section class="flex flex-row">
            <ul class="flex flex-row items-center gap-4">
                ...
                <li class="hidden sm:flex sm:flex-col sm:items-center">
                    ...
                    class="flex items-center relative p-2 text-gray-900 rounded-lg hover:bg-gray-100 hover:shadow-md group {{ Route::currentRouteName() == 'user.messages' ? 'bg-gray-100 shadow-md' : '' }}">
                        ...
                        <span class="absolute inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full -top-2 -right-2">
                            3
                        </span>
                    </a>
            ...
            <ul class="pl-4 sm:ml-4 space-x-2 font-medium sm:border-l border-black dark:border-gray-700">
        ...
        <section class="ml-10">
            <ul>
                <li class="flex flex-col items-center">
                    ...
                    <!-- Dropdown menu -->
                    <div id="userMenuMobileDropdown" class="z-10 hidden md:hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-56 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <!-- Dropdown menu -->
                    {{-- <div class="absolute right-12 z-10 mt-2 w-56 origin-top-right divide-y md:hidden divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                        role="menu" aria-labelledby="menu-button" tabindex="-1" id="">
                        <div class="px-4 py-3">
